  ...
  const data = [
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-8"> {/* Adjusted gap for equal spacing */}
      ...
      content: (
        <div>
          <p className="text-white text-xs md:text-lg font-normal mb-8">
            <TextGenerateEffect words=" I usually run out of copy, but when I see content this big, I try to
            integrate lorem ipsum."/>
          </p>
          <p className="text-white text-xs md:text-lg font-normal mb-8">
            <TextGenerateEffect words=" Lorem ipsum is for people who are too lazy to write copy. But we are
    ...
    },
    {
      ...
      content: (
        <div className="w-full flex flex-col items-start justify-center">
          ...
          <div className="w-full"> {/* Ensure this div is full width */}
